...
impl KeepVacmsecuritytogrouptable {
    fn new() -> Self {
       ...
       KeepVacmsecuritytogrouptable {
           table: TableMemOid::new(
             vec![vec![simple_from_int(4), simple_from_str(b"b"), simple_from_str(b"b"), simple_from_int(3), simple_from_int(4)]],
        vec![simple_from_int(4), simple_from_str(b"b"), simple_from_str(b"b"), simple_from_int(3), simple_from_int(4)],
        5,
        &base_oid,
        vec![OType::Integer, OType::String, OType::String, OType::Integer, OType::Integer],
...
impl KeepVacmaccesstable {
    fn new() -> Self {
       ...
       KeepVacmaccesstable {
           table: TableMemOid::new(
             vec![vec![simple_from_str(b"b"), simple_from_int(4), simple_from_int(4), simple_from_int(1), simple_from_str(b""), simple_from_str(b""), simple_from_str(b""), simple_from_int(3), simple_from_int(4)]],
        vec![simple_from_str(b"b"), simple_from_int(4), simple_from_int(4), simple_from_int(1), simple_from_str(b""), simple_from_str(b""), simple_from_str(b""), simple_from_int(3), simple_from_int(4)],
        9,
        &base_oid,
        vec![OType::String, OType::Integer, OType::Integer, OType::Integer, OType::String, OType::String, OType::String, OType::Integer, OType::Integer],
...
impl KeepVacmviewtreefamilytable {
    fn new() -> Self {
       ...
       KeepVacmviewtreefamilytable {
           table: TableMemOid::new(
             vec![vec![simple_from_str(b"b"), simple_from_vec(&[1, 3, 6, 1]), simple_from_str(b""), simple_from_int(1), simple_from_int(3), simple_from_int(4)]],
        vec![simple_from_str(b"b"), simple_from_vec(&[1, 3, 6, 1]), simple_from_str(b""), simple_from_int(1), simple_from_int(3), simple_from_int(4)],
        6,
        &base_oid,
        vec![OType::String, OType::ObjectId, OType::String, OType::Integer, OType::Integer, OType::Integer],
...
pub fn load_stub(oid_map: &mut OidMap) {
    ...
    let oid_vacm_access_table: ObjectIdentifier =
        ObjectIdentifier::new(&ARC_VACM_ACCESS_TABLE).unwrap();
    let k_vacm_access_table: Box<dyn OidKeeper> = 
       Box::new(KeepVacmaccesstable::new());
    ...
    let k_vacm_view_spin_lock: Box<dyn OidKeeper> = 
       Box::new(KeepVacmviewspinlock::new());
